  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="owl-carousel-wrapper">
      ...
      <div class="box-92819">
        ...
        <p class="lead text-white">Welcome to the Initiative for the Advancement of Improved Health and Development (I-AIHD). We are committed to protecting your privacy and ensuring that your personal information is handled securely and responsibly.</p>
      </div>
    ...
    <div class="site-section">
      <div class="container">
            ...
            <section>
                ...
                <ul>
                    <li>Your name, email address, and phone number when you contact us or subscribe to our updates.</li>
                    <li>Donation details if you contribute to our cause.</li>
                    <li>Browsing information such as IP addresses and cookies for analytics purposes.</li>
                </ul>
            </section>
            ...
            <section>
                ...
                <ul>
                    <li>To provide you with updates about our programs and initiatives.</li>
        ...
        <section>
            ...
            <p>We implement security measures to safeguard your data from unauthorized access, alteration, or disclosure. However, no online transmission is 100% secure, so we encourage users to take personal precautions as well.</p>
        </section>

        <section>
            <h2>Third-Party Sharing</h2>
            <p>We do not sell or trade your personal information. However, we may share data with trusted third parties such as:</p>
            <ul>
                <li>Payment processors for secure donation handling.</li>
                <li>Analytics providers to improve our website experience.</li>
        ...
        <section>
            <h2>Cookies</h2>
            <p>We use cookies to enhance your browsing experience. You can choose to disable cookies in your browser settings, but this may affect website functionality.</p>
        </section>
